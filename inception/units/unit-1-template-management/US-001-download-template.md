...
- Then I should see:
  ...
  - Sample data rows with realistic example values
...
- Then it should contain exactly these columns in order:
  contractNumber, contractDate, buyerName, sellerName, commodityName,
  commodityDescription, quantity, unit, tolerance, origin, packing,
  qualitySpec, unitPrice, currency, incoterm, portLocation, paymentTermName,
  bankName, accountName, accountNumber, swiftCode, shipmentPeriod,
  additionalTerms, releaseType, status
